...
-- Insert sample data
INSERT INTO public.machines (id, name, code, status, oee, availability, performance, quality, current_production, target_production, capacity) VALUES
('M001', 'Extrusora Alpha', 'EXT-001', 'ativa', 78.5, 92.3, 85.1, 99.8, 12500, 15000, 2500),
('M002', 'Impressora Beta', 'IMP-002', 'ativa', 62.4, 78.2, 89.7, 89.1, 8900, 12000, 2000),
('M003', 'Soldadora Gamma', 'SOL-003', 'manutencao', 0, 0, 0, 0, 0, 8000, 1600),
('M004', 'Cortadora Delta', 'COR-004', 'ativa', 88.7, 95.2, 93.1, 100, 18200, 20000, 4000),
('M005', 'Embaladera Epsilon', 'EMB-005', 'parada', 45.2, 65.8, 78.3, 87.8, 3200, 10000, 2500);
